...
import { t as require_ev_emitter } from "./react-flickity-component.js";
...
//#endregion
//#region node_modules/desandro-matches-selector/matches-selector.js
...
//#endregion
//#region node_modules/fizzy-ui-utils/utils.js
...
//#endregion
//#region node_modules/flickity/js/cell.js
var require_cell = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["get-size/get-size"], function(getSize) {
			return factory(window, getSize);
		});
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_get_size());
		else {
...
//#endregion
//#region node_modules/flickity/js/slide.js
var require_slide = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(factory);
		else if (typeof module == "object" && module.exports) module.exports = factory();
		else {
...
//#endregion
//#region node_modules/flickity/js/animate.js
var require_animate = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["fizzy-ui-utils/utils"], function(utils) {
			return factory(window, utils);
		});
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_utils());
		else {
			window.Flickity = window.Flickity || {};
		...
		proto.getPositionValue = function(position) {
			if (this.options.percentPosition) return Math.round(position / this.size.innerWidth * 1e4) * .01 + "%";
			else return Math.round(position) + "px";
		};
		...
		proto.applySelectedAttraction = function() {
			...
			var force = (this.selectedSlide.target * -1 - this.x) * this.options.selectedAttraction;
...
//#endregion
//#region node_modules/flickity/js/flickity.js
var require_flickity = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		...
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_ev_emitter(), require_get_size(), require_utils(), require_cell(), require_slide(), require_animate());
		else {
		...
		*/
		...
		proto.activate = function() {
			...
			this.getSize();
			moveElements(this._filterFindCellElements(this.element.children), this.slider);
		...
		*/
		...
		proto._wrapSelect = function(index) {
			...
			if (!(this.options.wrapAround && len > 1)) return index;
		...
		*/
		...
		proto.getCellSlideIndex = function(cell) {
			for (var i = 0; i < this.slides.length; i++) if (this.slides[i].cells.indexOf(cell) != -1) return i;
		};
		/**
		...
		*/
		...
		proto.watchCSS = function() {
			...
			if (getComputedStyle(this.element, ":after").content.indexOf("flickity") != -1) this.activate();
...
//#endregion
//#region node_modules/unipointer/unipointer.js
var require_unipointer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* Unipointer v2.4.0
	...
	*/
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["ev-emitter/ev-emitter"], function(EvEmitter) {
			return factory(window, EvEmitter);
		});
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_ev_emitter());
		else window.Unipointer = factory(window, window.EvEmitter);
		...
		*/
		proto._bindStartEvent = function(elem, isAdd) {
			...
			if ("ontouchstart" in window) startEvent = "touchstart";
			else if (window.PointerEvent) startEvent = "pointerdown";
...
var require_unidragger = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["unipointer/unipointer"], function(Unipointer) {
			return factory(window, Unipointer);
		});
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_unipointer());
		else window.Unidragger = factory(window, window.Unipointer);
		...
		*/
		...
		proto._dragPointerUp = function(event, pointer) {
			...
			else this._staticClick(event, pointer);
		};
...
//#endregion
//#region node_modules/flickity/js/drag.js
var require_drag = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define([
			"./flickity",
		...
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_flickity(), require_unidragger(), require_utils());
		else window.Flickity = factory(window, window.Flickity, window.Unidragger, window.fizzyUIUtils);
		...
		proto.pointerDownFocus = function(event) {
			if (!focusNodes[event.target.nodeName]) this.focus();
		};
		...
		proto.dragEnd = function(event, pointer) {
			...
			} else if (!this.options.freeScroll && index == this.selectedIndex) index += this.dragEndBoostSelect();
		...
		*/
		...
		proto.dragEndBoostSelect = function() {
			if (this.previousDragX === void 0 || !this.dragMoveTime || /* @__PURE__ */ new Date() - this.dragMoveTime > 100) return 0;
			var distance = this.getSlideDistance(-this.dragX, this.selectedIndex);
			var delta = this.previousDragX - this.dragX;
			if (distance > 0 && delta > 0) return 1;
			else if (distance < 0 && delta < 0) return -1;
			return 0;
		};
		proto.staticClick = function(event, pointer) {
...
//#endregion
//#region node_modules/flickity/js/prev-next-button.js
var require_prev_next_button = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define([
			"./flickity",
		...
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_flickity(), require_unipointer(), require_utils());
		else factory(window, window.Flickity, window.Unipointer, window.fizzyUIUtils);
...
//#endregion
//#region node_modules/flickity/js/page-dots.js
var require_page_dots = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define([
			"./flickity",
			"unipointer/unipointer",
...
//#endregion
//#region node_modules/flickity/js/player.js
var require_player = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		...
		else if (typeof module == "object" && module.exports) module.exports = factory(require_ev_emitter(), require_utils(), require_flickity());
		else factory(window.EvEmitter, window.fizzyUIUtils, window.Flickity);
...
//#endregion
//#region node_modules/flickity/js/add-remove-cell.js
var require_add_remove_cell = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["./flickity", "fizzy-ui-utils/utils"], function(Flickity, utils) {
			return factory(window, Flickity, utils);
		});
		else if (typeof module == "object" && module.exports) module.exports = factory(window, require_flickity(), require_utils());
		else factory(window, window.Flickity, window.fizzyUIUtils);
...
//#endregion
//#region node_modules/flickity/js/lazyload.js
var require_lazyload = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(window, factory) {
		if (typeof define == "function" && define.amd) define(["./flickity", "fizzy-ui-utils/utils"], function(Flickity, utils) {
			return factory(window, Flickity, utils);
		});
...
//#endregion
//#region node_modules/flickity/js/index.js
var require_js = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	(function(window, factory) {
		...
		else if (typeof module == "object" && module.exports) module.exports = factory(require_flickity(), require_drag(), require_prev_next_button(), require_page_dots(), require_player(), require_add_remove_cell(), require_lazyload());
